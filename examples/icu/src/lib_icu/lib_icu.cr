...
lib LibICU
  ...
  fun u_char_age = u_charAge_55(c : UChar32, version_array : UVersionInfo)
  fun u_char_digit_value = u_charDigitValue_55(c : UChar32) : Int32T
  fun u_char_direction = u_charDirection_55(c : UChar32) : UCharDirection
  fun u_char_from_name = u_charFromName_55(name_choice : UCharNameChoice, name : LibC::Char*, p_error_code : UErrorCode*) : UChar32
  fun u_char_mirror = u_charMirror_55(c : UChar32) : UChar32
  fun u_char_name = u_charName_55(code : UChar32, name_choice : UCharNameChoice, buffer : LibC::Char*, buffer_length : Int32T, p_error_code : UErrorCode*) : Int32T
  fun u_char_type = u_charType_55(c : UChar32) : Int8T
  fun u_digit = u_digit_55(ch : UChar32, radix : Int8T) : Int32T
  fun u_enum_char_names = u_enumCharNames_55(start : UChar32, limit : UChar32, fn : (Void*, UChar32, UCharNameChoice, LibC::Char*, Int32T -> UBool), context : Void*, name_choice : UCharNameChoice, p_error_code : UErrorCode*)
  fun u_enum_char_types = u_enumCharTypes_55(enum_range : (Void*, UChar32, UChar32, UCharCategory -> UBool), context : Void*)
  fun u_error_name = u_errorName_55(code : UErrorCode) : LibC::Char*
  fun u_fold_case = u_foldCase_55(c : UChar32, options : Uint32T) : UChar32
  fun u_for_digit = u_forDigit_55(digit : Int32T, radix : Int8T) : UChar32
  fun u_get_bidi_paired_bracket = u_getBidiPairedBracket_55(c : UChar32) : UChar32
  fun u_get_combining_class = u_getCombiningClass_55(c : UChar32) : Uint8T
  fun u_get_fc_nfkc_closure = u_getFC_NFKC_Closure_55(c : UChar32, dest : UChar*, dest_capacity : Int32T, p_error_code : UErrorCode*) : Int32T
  fun u_get_int_property_max_value = u_getIntPropertyMaxValue_55(which : UProperty) : Int32T
  fun u_get_int_property_min_value = u_getIntPropertyMinValue_55(which : UProperty) : Int32T
  fun u_get_int_property_value = u_getIntPropertyValue_55(c : UChar32, which : UProperty) : Int32T
  fun u_get_iso_comment = u_getISOComment_55(c : UChar32, dest : LibC::Char*, dest_capacity : Int32T, p_error_code : UErrorCode*) : Int32T
  fun u_get_numeric_value = u_getNumericValue_55(c : UChar32) : LibC::Double
  fun u_get_property_enum = u_getPropertyEnum_55(alias : LibC::Char*) : UProperty
  fun u_get_property_name = u_getPropertyName_55(property : UProperty, name_choice : UPropertyNameChoice) : LibC::Char*
  fun u_get_property_value_enum = u_getPropertyValueEnum_55(property : UProperty, alias : LibC::Char*) : Int32T
  fun u_get_property_value_name = u_getPropertyValueName_55(property : UProperty, value : Int32T, name_choice : UPropertyNameChoice) : LibC::Char*
  fun u_get_unicode_version = u_getUnicodeVersion_55(version_array : UVersionInfo)
  fun u_get_version = u_getVersion_55(version_array : UVersionInfo)
  fun u_has_binary_property = u_hasBinaryProperty_55(c : UChar32, which : UProperty) : UBool
  fun u_is_id_ignorable = u_isIDIgnorable_55(c : UChar32) : UBool
  fun u_is_id_part = u_isIDPart_55(c : UChar32) : UBool
  fun u_is_id_start = u_isIDStart_55(c : UChar32) : UBool
  fun u_is_iso_control = u_isISOControl_55(c : UChar32) : UBool
  fun u_is_java_id_part = u_isJavaIDPart_55(c : UChar32) : UBool
  fun u_is_java_id_start = u_isJavaIDStart_55(c : UChar32) : UBool
  fun u_is_java_space_char = u_isJavaSpaceChar_55(c : UChar32) : UBool
  fun u_is_mirrored = u_isMirrored_55(c : UChar32) : UBool
  fun u_is_u_alphabetic = u_isUAlphabetic_55(c : UChar32) : UBool
  fun u_is_u_lowercase = u_isULowercase_55(c : UChar32) : UBool
  fun u_is_u_uppercase = u_isUUppercase_55(c : UChar32) : UBool
  fun u_is_u_white_space = u_isUWhiteSpace_55(c : UChar32) : UBool
  fun u_is_whitespace = u_isWhitespace_55(c : UChar32) : UBool
  fun u_isalnum = u_isalnum_55(c : UChar32) : UBool
  fun u_isalpha = u_isalpha_55(c : UChar32) : UBool
  fun u_isbase = u_isbase_55(c : UChar32) : UBool
  fun u_isblank = u_isblank_55(c : UChar32) : UBool
  fun u_iscntrl = u_iscntrl_55(c : UChar32) : UBool
  fun u_isdefined = u_isdefined_55(c : UChar32) : UBool
  fun u_isdigit = u_isdigit_55(c : UChar32) : UBool
  fun u_isgraph = u_isgraph_55(c : UChar32) : UBool
  fun u_islower = u_islower_55(c : UChar32) : UBool
  fun u_isprint = u_isprint_55(c : UChar32) : UBool
  fun u_ispunct = u_ispunct_55(c : UChar32) : UBool
  fun u_isspace = u_isspace_55(c : UChar32) : UBool
  fun u_istitle = u_istitle_55(c : UChar32) : UBool
  fun u_isupper = u_isupper_55(c : UChar32) : UBool
  fun u_isxdigit = u_isxdigit_55(c : UChar32) : UBool
  fun u_tolower = u_tolower_55(c : UChar32) : UChar32
  fun u_totitle = u_totitle_55(c : UChar32) : UChar32
  fun u_toupper = u_toupper_55(c : UChar32) : UChar32
  fun u_version_from_string = u_versionFromString_55(version_array : UVersionInfo, version_string : LibC::Char*)
  fun u_version_from_u_string = u_versionFromUString_55(version_array : UVersionInfo, version_string : UChar*)
  fun u_version_to_string = u_versionToString_55(version_array : UVersionInfo, version_string : LibC::Char*)
